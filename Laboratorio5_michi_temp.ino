...
#define AIO_KEY         "aio_qGoP14Chq3Fp8tMuOA5O8bVlxKuf"
...
/******** Feeds ********/
Adafruit_MQTT_Publish pubTemp = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/laboratorio-5");
Adafruit_MQTT_Publish pubHum  = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/laboratorio-5");
